...
async function runDailyUpdate(client) {
  try {
    ...
    if (!channel || !channel.isTextBased()) {
      ...
      return { success: false, message: 'ไม่พบช่องประกาศ' };
    }
...
module.exports = { setupDailyUpdate, runDailyUpdate };
